        ...
        if (inputData != null) {
            ...
            if (gamePolicy == GamePolicy.LooseOperation)
            {
                if (inputData.validity == InputValidity.Accepted)
                {
                    ...
                    //gameController.narrativeEvent = NarrativeEvent.InputAccepted;
                    //GameEventData gameEvent = gameController.CreateGameEventData();
                    //gameController.onGameEventChanged.Invoke(gameEvent);
